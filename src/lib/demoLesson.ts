...
export const demoLesson: LessonData = {
  ...
  activities: [
    {
      ...
      teacher_moves: [
        ...
        'When a student says "there are 2 X\'s for every 1 Y" — even casually — make a note. You will come back to it in 1.2.',
      ],
      causal_link: null,
      extension: null,
    },
    {
      ...
      teacher_moves: [
        'Slow groups down here. The point is not to fill in the blanks fast — it is to read the sentence and feel it make sense.',
        'When a student gets it right, ask them to read it aloud. For them and for the room.',
    ...
    },
    {
      ...
      teacher_moves: [
        ...
        'When a student catches their own mistake before you do, name it for them: "you just used a ratio to check your own work."',
      ],
      causal_link:
  ...
  adaptation_guardrails: {
    ...
    do_not_remove: [
      ...
      'Students must read their ratio sentence aloud at some point. Silent fill-in-the-blank is not the same activity.',
    ...
    by_proficiency: {
      entering:
        'Pair the student with someone who shares their home language. Let them write the ratio sentence in their home language first, then translate one form into English. The math work is in writing the sentence — not in English specifically.',
      developing:
        'Provide the sentence frames written out clearly. Let the student say the sentence aloud with their partner before writing it alone. Hearing the sentence said correctly first is the support.',
      bridging:
        'Use the lesson as written. Push these students to write all three forms and explain which one feels most natural — start to build their awareness of how the same relationship sounds different in different forms.',
    },
  },
    ...
    activities: [
      {
        ...
        patterns: [
          ...
          },
          {
            ...
            move:
              'Pause the room. Have the student repeat what they said so everyone hears it. Tell them you are going to come back to that exact way of saying it in a few minutes.',
            is_mll_specific: false,
          },
          {
        ...
        sentence_frames: [
          'I sorted by __ because __.',
          'I see __ groups of __.',
          'My partner sorted by __, so they have __ groups.',
        ],
        ...
        patterns: [
          {
            ...
            move:
              'Ask them to read it aloud. Then ask: "which one comes first — squares or circles?" Let them feel the order matter without telling them they are wrong.',
            is_mll_specific: false,
          },
          {
            ...
            move:
              'Stop and ask them to share with the room. This is the synthesis the lesson is going for. Make their observation public.',
            is_mll_specific: false,
          },
          {
            ...
            move:
              'Affirm the meaning of what they wrote. Then ask: "can you write that same thing using one of the sentence frames? Why do you think we are using the frame?"',
            is_mll_specific: false,
          },
          {
            ...
            move:
              'MLL-specific support — see the Move Walkthrough scenarios for this activity. The issue is usually language, not math.',
      ...
      },
      {
        ...
        patterns: [
          ...
          },
          {
            ...
            move:
              'Confirm with one question: "now what is the ratio of pens to markers? Same kind of sentence?"',
            is_mll_specific: false,
          },
          {
            ...
            move:
              'Stop the class. Show the display. Ask: "what ratio does this show? Can someone say it in words?" Make the visual-to-words translation public.',
            is_mll_specific: false,
          },
        ],
        sentence_frames: [
          'I sorted my collection by __.',
          'The ratio of __ to __ is __ to __.',
          'I can see this in my display because __.',
        ],
        questions_to_listen_for: [
    ...
    activities: [
      {
        ...
        scenarios: [
          ...
          },
          {
            ...
            is_mll: false,
            flat_move: {
              move: 'Stop the room. Have the student repeat what they said.',
              say: '"Hold on — I want everyone to hear what [name] just said. Can you say it again? Class — did you hear those words? \'For every.\' We are going to come back to that in a minute."',
              nonverbal: null,
              avoid: 'Saying "great!" and moving on. The praise privatizes the insight. The class needs to hear the words, not just see you nod.',
            },
      ...
      },
      {
        ...
        scenarios: [
          ...
          },
          {
            ...
            is_mll: false,
            flat_move: {
              move: 'Throw the question back to the class.',
              say: '"That is a great question. Class — [name] just asked why we are writing all three forms. What do you think? Are they saying the same thing? Why might it matter to know all three?"',
              nonverbal: null,
              avoid: 'Answering the question directly. The point is that the class realizes the three forms are equivalent — not that you tell them.',
            },
            proficiency_moves: null,
            mll_framework_note: null,
          },
        ...
        scenarios: [
          ...
          },
          {
            ...
            flat_move: {
              ...
              say: null,
              nonverbal:
                'Stand near them but not over them. If they look up, nod once and step away. The signal is "I see you working — keep going."',
              avoid:
          ...
          },
          {
            ...
            is_mll: false,
            flat_move: {
              move: 'Pull the observation into the room.',
              say: '"That is a great question. [Name] noticed that they and their partner had the same items but different ratios. Class — how can that be? Talk to your partner for one minute."',
              nonverbal: null,
              avoid: 'Answering the question directly. The class needs to wrestle with this — the next lesson builds on it.',
            },
            proficiency_moves: null,
            mll_framework_note: null,
          },
