  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col">
      ...
      {wb.activities.some((wba) => wba.tiles.some((t) => t.friction_type && (t.friction_type === 'math' || t.friction_type === 'language' || t.friction_type === 'language-math'))) && (
        <section className="w-full mt-4 rounded-lg bg-white border border-gray-200 shadow-sm overflow-hidden">
          <div className="px-4 py-3 border-b border-gray-100 bg-blue-50">
            <p className="text-[10px] font-bold uppercase tracking-[0.1em] text-[#26215C]">
              Friction Types
            </p>
          </div>
